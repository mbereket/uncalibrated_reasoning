...
uv run python3 -m verl.trainer.main_ppo \
    ...
    critic.model.path=${PROJECT_ROOT}/data_cache/models/Qwen3-4B \
    ...
    trainer.experiment_name=final_ppo \
    ...
    trainer.default_local_dir=${PROJECT_ROOT}/data_cache/experiments/final_ppo/ \
